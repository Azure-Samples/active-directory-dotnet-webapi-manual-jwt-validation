...
1. Find the key `todo:TodoListScope` and replace the value in square parentheses with the App ID URI you registered earlier, when exposing an API. For instance use `api://<application_id>`.
